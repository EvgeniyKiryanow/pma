...
/** Self-service password reset with the one-time recovery code (inside the «Вхід» tab). */
export default function RecoverPasswordForm({
    ...
    return (
        <form onSubmit={submit} className="space-y-4">
            <div>
                <h2 className="text-base font-semibold text-ink">{t('auth.recover.title')}</h2>
                <p className="mt-1 text-sm text-ink-3">{t('auth.recover.subtitle')}</p>
            </div>

            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between bg-gradient-to-r from-blue-50 to-white border border-gray-200 rounded-xl shadow-sm p-4">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                    ...
                    <div className="relative">
                        ...
                        <select
                            className="w-[150px] pl-9 pr-4 py-2 rounded-full border border-gray-300 bg-white text-sm shadow hover:border-blue-400 focus:border-blue-500 focus:ring focus:ring-blue-200 transition"
                            value={currentStatus || ''}

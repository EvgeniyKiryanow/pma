...
/** The period of the latest status change of a person that has one (the staff report). */
export type LatestStatusPeriod = { userId: number; from: string; to: string | null };

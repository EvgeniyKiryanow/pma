...
export default function LeftBar({ users, selectedUser, onSelectUser }: LeftBarProps) {
                ...
                {filteredUsers.length > 0 ? (
                    filteredUsers.map((user, index) => (
                        ...
                        >
                            ...
                            <img src={user.photo || ''} className="h-4 w-4 mr-[5px]" alt="" />
                            <span className="mr-[5px]">{user.fullName}</span>
